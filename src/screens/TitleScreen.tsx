  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-8 relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center gap-8 max-w-lg text-center">
        ...
        {/* Title */}
        <div>
          <h1 className="text-5xl font-bold text-amber-400 tracking-tight mb-2 font-serif">
            Divine Expedition
          </h1>
        ...
        {/* Tagline */}
        <div className="border border-gray-700 rounded-xl p-5 bg-gray-900/60 backdrop-blur">
        ...
        {/* Three pillars */}
        <div className="grid grid-cols-3 gap-4 text-sm text-center w-full">
          {[
            ...
            <div key={p.label} className="panel p-3 flex flex-col items-center gap-1">
        ...
        <button
          onClick={onStart}
          className="btn-primary text-lg px-10 py-3 w-full max-w-xs"
        >
          Begin Your Reign
        </button>
